...
class TopicEvidenceRetriever:
    ...
    def retrieve_for_topic(
        ...
        *,
        ...
        for lead in topic.source_leads:
            ...
            for chunk in self._load_explicit_chunks(lead.source_id, lead.chunk_ids, warnings):
                ...
                if len(chunks) >= max_chunks:
                    return RetrievedTopicEvidence(topic_id=topic.id, chunks=chunks, warnings=warnings)

            for query in lead.suggested_search_queries:
